...
<nav class="navbar navbar-expand-sm justify-content-end bg-primary navbar-dark"> <!--fixed-top-->
    ...
    <ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link" href="#"><button type="submit" class="btn btn-primary">Register</button></a>
    </li>
</nav>
...
<div class="container">
  ...
  <img src="assets\images\logo.png" alt="Exam claim manegement System" height="100px" width="100px" class="mx-auto d-block">
   <h3 class="text-primary text-center">Welome to Login</h3>
    ...
    <div class="col-12 p-3">
        ...
        <form>
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" aria-describedby="" placeholder="Enter Email Id">
          </div>

          <div class="form-group">
            <label for="password">Password</label>
            <input type="password" class="form-control" id="password" aria-describedby="" placeholder="Enter Password">
          </div>
        </form>
        ...
        <form>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                        Forgot password <a href="#" target="_blank" >Click here</a><br>
                </div>
            </div>
