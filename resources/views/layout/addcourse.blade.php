    ...
    <div class="col-12 p-3">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="name" aria-describedby="" placeholder="Enter Course Name">
          </div>
            <div class="form-group col-md-6">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="level" placeholder="Enter Course Level">
            </div>
            <div class="form-group col-md-6">
              <label for="num_of_credits">Number of Credits</label>
              <input type="text" class="form-control" id="num_of_credits" placeholder="Enter Number of Credits">
            </div>
