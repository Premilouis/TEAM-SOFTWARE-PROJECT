...
<div class="container">
  ...
  <img src="assets\images\logo.png" alt="Exam claim manegement System" height="100px" width="100px" class="mx-auto d-block">
   <h3 class="text-primary text-center">Add Exam</h3>
        ...
        <form>
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="num_of_students" placeholder="Enter Number Of Students">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="num_of_pages" placeholder="Enter Number Of Pages">
            </div>
            <div class="form-group col-md-6">
              <label for="num_of_groups">Number Of Groups</label>
              <input type="text" class="form-control" id="num_of_groups" placeholder="Enter Number Of Groups">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="kind" placeholder="Enter Kind">
            </div>
            <div class="form-group col-md-6">
              <label for="date">Date</label>
              <input type="date" class="form-control" id="date" placeholder="shedule exam date">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="time" class="form-control" id="start_time" placeholder="Add Start Time">
            </div>
            <div class="form-group col-md-6">
              <label for="end_time">End Time</label>
              <input type="time" class="form-control" id="end_time" placeholder="Add End Time">
            </div>
          </div>
