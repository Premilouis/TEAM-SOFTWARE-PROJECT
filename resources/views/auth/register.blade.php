            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="bank_acc_num" class="col-md-4 col-form-label text-md-right">{{ __('Bank Acc Num') }}</label>

                            <div class="col-md-6">
                                <input id="bank_acc_num" type="text" class="form-control @error('bank_acc_num') is-invalid @enderror" name="bank_acc_num" value="{{ old('bank_acc_num') }}" required autocomplete="bank_acc_num" autofocus>
