...
<div>
        ...
        <a id="navbarDropdown" class="btn btn-lg btn-primary w-25" role="button"" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
        {{ Auth::user()->user_name }}
        </a>
...
<div class="col-7">
    <div class="col-12 p-3">
        <form>
        <a href="/admindashboard" class="btn btn-lg btn-primary w-25" role="button">Admin Dashboard</a>
        <a href="/hoddashboard" class="btn btn-lg btn-primary w-25" role="button">HOD Dashboard</a>
        <a href="/examinerdashboard" class="btn btn-lg btn-primary w-25" role="button">Examiner Dashboard</a>
