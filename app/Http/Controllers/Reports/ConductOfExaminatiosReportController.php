...
class ConductOfExaminatiosReportController extends Controller
{
    // For index page
    public function index()
   {
        ...
        ->select(
            ...
            'exams.num_of_groups as examNumOfGroups',
        ...
        return view('conductofexaminations.index', compact('payments'));
